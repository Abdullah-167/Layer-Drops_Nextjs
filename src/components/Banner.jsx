...
const Banner = () => {
    return (
        <div className='container'>
            <div className='border-gradient border-[20px]  rounded-[39px] mb-24 mx-3 sm:mx-6'>
                <div className='border-4 border-light-blue rounded-[19.9px]'>
                    <div className='lg:flex block bg-primary justify-center lg:justify-between gap-3 items-center lg:px-8 xl:px-16 py-10 rounded-2xl'>
                        ...
                        <div className='block sm:flex justify-center items-center gap-6 xl:gap-10 mx-auto w-full sm:w-[500px] mt-3'>
                            ...
                            <div className=' bg-secondary text-white w-[240px] sm:w-[170px] rounded-md sm:rounded-xl cursor-pointer  text-center mx-auto sm:mt-0 mt-5'>
                                <button className='py-3 sm:py-4 text-base'>
                                    Get a Quote
                                </button>
                            </div>
                        </div>
