    ...
    return (
        <div className='bg-[#E4E7EA] mb-20'>
            <div className='container'>
                <div className='flex justify-center gap-4 items-center pt-32 pb-6'>
                    <span> <Image src={RightArrows} /> </span>
                    <h1 className='text-dark text-base'>DEFAULT SUB TEXT</h1>
                    <span> <Image src={LeftArrows} /> </span>
                </div>
                <div className='max-w-[600px] mx-auto mb-10'>
                    <h1 className='text-primary text-5xl text-center '>Our easy work process in 4 steps
                    </h1>
                </div>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 pb-14'>
                    <div>
                ...
                <div className=' sm:flex justify-center pb-20'>
                    <input className='w-full sm:w-[430px] py-3 pl-10 pr-3 outline-none bg-[#F2F5F9] text-light-gray rounded-lg' placeholder="Don't Hesitate, Contact us for better future life" type="text" />
                    <div className=' bg-secondary text-white w-[170px] mx-auto mt-6 sm:mt-0  rounded-lg sm:rounded-tr-lg sm:rounded-br-lg cursor-pointer  text-center'>
